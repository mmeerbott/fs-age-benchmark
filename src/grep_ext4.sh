...
umount $AGED_PATH &>> log_ext4_ext4.txt
mount $AGED_BLKDEV $AGED_PATH &>> log_ext4.txt
...
mkfs.ext4 -f $UNAGED_BLKDEV &>> log_ext4.txt
mount $UNAGED_BLKDEV $UNAGED_PATH &>> log_ext4.txt
cp -a $AGED_PATH/* $UNAGED_PATH
umount $UNAGED_PATH &>> log_ext4.txt
